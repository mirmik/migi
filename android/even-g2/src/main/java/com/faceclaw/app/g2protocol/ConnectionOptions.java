...
public class ConnectionOptions {
    ...
    // Migi experiment: a new communicator restarts delta fids at 1, while CFW
    // can retain its duplicate-fid ring across cleanup/reconnect. Full mode-6
    // frames have no fid and do not depend on that cross-session state.
